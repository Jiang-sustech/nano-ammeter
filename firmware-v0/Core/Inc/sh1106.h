...
// 移植自 SH1106-master (STM32F103 -> STM32L431)
// 引脚按新板网表 (HS13L01 模块, 见屏幕说明书 Pin Definition):
//   1 GND   2 VCC(3V3)   3 SCL=PB13   4 SDA=PB15
//   5 DC=PB14   6 CS1=PB12   7 FS0(NC)   8 CS2(接3V3禁用字库)
// 模块无 RES 引出脚, 靠内部上电复位, 故 RST 宏为空操作
...
// GPIO peripherals
#define SH1106_GPIO_PERIPH   (RCC_AHB2ENR_GPIOBEN)

// SH1106 RS/A0 (Data/Command select) pin (PB14)
...
// SH1106 RST (Reset) pin -- 本模块(HS13L01)未引出 RES 脚, 靠内部上电复位
#define SH1106_RST_H()       {}
#define SH1106_RST_L()       {}
